...
public class Modelo {
  private static Persona_Modelo [] listanombre_clientes;
   ...
   public static void crearArreglo_estatico(){
    ...
    Persona_Modelo objpersona = new Persona_Modelo  ("Jahir" , "Vera" , 19);
    Modelo.listanombre_clientes[0]= objpersona;
    Modelo.listanombre_clientes[1]=  new Persona_Modelo  ("kevin" , "Lopez" , 20);
    Modelo.listanombre_clientes[2]=  new Persona_Modelo  ("messi" , "Lioner" , 30);
...
public static void CrearArregloDinamico(){
 Modelo.listaCliente.add(new cliente("m", "perez"));
 Modelo.listaCliente.add(new cliente("f", "arroyo"));
 Modelo.listaCliente.add(new cliente("m", "xd"));
